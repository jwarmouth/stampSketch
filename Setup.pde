...
void loadSpriteSets()
{
  ...
  armbSet = new SpriteSet("arm b", "armb", 5);
  armRedSet = new SpriteSet("arm red", "arm-red", 5);

  // ROOTS
  blockRedSet = new SpriteSet("red block", "red-block", 3);
  blockBlackSet = new SpriteSet("black block", "black-block", 3);
  bigBlockSet = new SpriteSet("big block", "big-block", 1);
  rectSet = new SpriteSet("rect", "red-rect", 4);

  // TIPS
  tipBlockRedSet = new SpriteSet("red block", "red-block", 3);
  tipBlockBlackSet = new SpriteSet("black block", "black-block", 3);
  ...
  segmentSets = new SpriteSet[] {null, armSet, armbSet, armRedSet};
